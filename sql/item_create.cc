                                 ...
                                 List<Item> *item_list)
{
  ...
  if (unlikely(arg1->is_explicit_name() ||
               (arg2 && arg2->is_explicit_name())))
  {
    my_error(ER_WRONG_PARAMETERS_TO_NATIVE_FCT, MYF(0), name->str);
    return nullptr;
  }
  ...
  return arg2
    ? new (thd->mem_root) Item_func_crc32(thd, arg1, arg2)
    : new (thd->mem_root) Item_func_crc32(thd, arg1);
}
                                  ...
                                  List<Item> *item_list)
{
  ...
  return arg2
    ? new (thd->mem_root) Item_func_crc32c(thd, arg1, arg2)
    : new (thd->mem_root) Item_func_crc32c(thd, arg1);
}
